      ...
      <div className="w-full px-4 md:px-8 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 lg:gap-28 max-w-7xl mx-auto items-center">
          ...
          <div className="relative order-1 md:order-2 h-[420px] md:h-[520px] lg:h-[600px] xl:h-[640px] pointer-events-none select-none" aria-hidden>
            ...
            >
              <Card className="rounded-lg shadow-lg ring-1 ring-accent/20 bg-background/80 backdrop-blur-xl border border-accent/30 w-[7rem] md:w-[10.5rem] lg:w-[13rem] xl:w-[15rem]" style={{boxShadow: '0 0 1.25rem hsl(var(--shadow-color) / 0.25)'}}>
                ...
                <CardContent className="pt-0 px-2 pb-2 md:px-3 lg:px-4 xl:px-6 md:pb-3 lg:pb-4 xl:pb-6">
                  ...
                  <div className="h-1 md:h-1.5 lg:h-2 w-full rounded-full bg-muted overflow-hidden border border-[#868F9A]">
            ...
            >
              <Card className="rounded-lg shadow-lg ring-1 ring-accent/20 bg-background/80 backdrop-blur-xl border border-accent/30 w-[9rem] md:w-[13rem] lg:w-[16.5rem] xl:w-[18.75rem]" style={{boxShadow: '0 0 1.25rem hsl(var(--shadow-color) / 0.25)'}}>
            ...
            >
              <Card className="rounded-lg shadow-lg ring-1 ring-accent/20 bg-background/80 backdrop-blur-xl border border-accent/30 w-[6.875rem] md:w-[9.5rem] lg:w-[12rem] xl:w-[13.75rem]" style={{boxShadow: '0 0 1.25rem hsl(var(--shadow-color) / 0.25)'}}>
            ...
            >
              <Card className="rounded-lg shadow-lg ring-1 ring-accent/20 bg-background/80 backdrop-blur-xl border border-accent/30 w-[7.5rem] md:w-[10.5rem] lg:w-[13.5rem] xl:w-[15rem]" style={{boxShadow: '0 0 1.25rem hsl(var(--shadow-color) / 0.25)'}}>
                <CardHeader className="pb-0.5 px-2 pt-2 md:pb-1 md:px-3 lg:px-4 xl:px-6 md:pt-3 lg:pt-4 xl:pt-6">
